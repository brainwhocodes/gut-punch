import type { Job, JobResult, BackoffStrategy } from "../../index.ts"; // Import Job interface
import { JobRunStatus } from "../../index.ts";
...
export class ExampleJob implements Job { // Implement Job
  ...
  public readonly rescheduleIn: number = 1000 * 60 * 60; // 1 hour
